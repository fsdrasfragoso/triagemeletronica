 ...
 */
public class Tela_Do_Medico extends javax.swing.JFrame {

    /**
     * Creates new form Tela_Principal
     */
    public Tela_Do_Medico() {
        initComponents();
    }
    ...
    private void jMenuItem11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem11ActionPerformed
        ...
        Tela_Medico_Alterar_Dados tma = new Tela_Medico_Alterar_Dados();
        tma.setVisible(true);
        Desktop.add(tma);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Do_Medico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tela_Do_Medico().setVisible(true);
            }
        });
    }
